...
agenda_staff(d9767, 20241209, [(720, 790, m01), (1080, 1140, c01)]).
agenda_staff(d8290, 20241209, [(901, 960, m02), (1380, 1440, c02)]).
agenda_staff(d9368, 20241209, [(720, 790, m01), (910, 980, m02)]).
agenda_staff(d7282, 20241209, []).
agenda_staff(d0719, 20241209, []).

agenda_staff(n7073, 20241209, []).
agenda_staff(n002, 20241209, []).
agenda_staff(n5177, 20241209, []).
agenda_staff(t1756, 20241209, []).
agenda_staff(n7902, 20241209, []).
agenda_staff(n1238, 20241209, []).
agenda_staff(n2519, 20241209, []).
agenda_staff(t0534, 20241209, []).

agenda_staff(d9767, 20241210, []).
agenda_staff(d8290, 20241210, []).
agenda_staff(d9368, 20241210, []).
agenda_staff(d7282, 20241210, []).
agenda_staff(d0719, 20241210, []).

agenda_staff(n7073, 20241210, []).
agenda_staff(n002, 20241210, []).
agenda_staff(n5177, 20241210, []).
agenda_staff(t1756, 20241210, []).
agenda_staff(n7902, 20241210, []).
agenda_staff(n1238, 20241210, []).
agenda_staff(n2519, 20241210, []).
agenda_staff(t0534, 20241210, []).

timetable(d9767, 20241209, (480, 1200)).
timetable(d8290, 20241209, (500, 1440)).
timetable(d9368, 20241209, (520, 1320)).
timetable(d7282, 20241209, (480, 1200)).
timetable(d0719, 20241209, (500, 1440)).
timetable(n7073, 20241209, (520, 1320)).
timetable(n002, 20241209, (480, 1200)).
timetable(n5177, 20241209, (500, 1440)).
timetable(t1756, 20241209, (520, 1320)).
timetable(n7902, 20241209, (480, 1200)).
timetable(n1238, 20241209, (500, 1440)).
timetable(n2519, 20241209, (520, 1320)).
timetable(t0534, 20241209, (520, 1320)).

timetable(d9767, 20241210, (480, 1200)).
timetable(d8290, 20241210, (500, 1440)).
timetable(d9368, 20241210, (520, 1320)).
timetable(d7282, 20241210, (480, 1200)).
timetable(d0719, 20241210, (500, 1440)).
timetable(n7073, 20241210, (520, 1320)).
timetable(n002, 20241210, (480, 1200)).
timetable(n5177, 20241210, (500, 1440)).
timetable(t1756, 20241210, (520, 1320)).
timetable(n7902, 20241210, (480, 1200)).
timetable(n1238, 20241210, (500, 1440)).
timetable(n2519, 20241210, (520, 1320)).
timetable(t0534, 20241210, (520, 1320)).
...
agenda_operation_room(r0001,20241209,[]).
agenda_operation_room(r0002,20241209,[]).
agenda_operation_room(r0003,20241209,[]).

agenda_operation_room(r0001,20241210,[]).
agenda_operation_room(r0002,20241210,[]).
agenda_operation_room(r0003,20241210,[]).
...
availability_all_surgeries_heuristics([],_,_).
availability_all_surgeries_heuristics([OpCode|LOpCode],Room,Day):-
    ...
    remove_unf_intervals_heuristics(TTotal,GlobalAgenda,LPossibilities),
    ( 
        LPossibilities \= [] -> 
        (
            schedule_first_interval_heuristics(TTotal, LPossibilities, (TinS, TfinS)),
    ...
    availability_all_surgeries_heuristics(IdList,Room,Day).
...
heuristic_by_time([OpCode | LOpCode], Room, Day, SortedLOpCode) :- 
    ...
    availability_operation_heuristics(OpCode, Room, Day, LPossibilities, _),
    
   
    
    (LPossibilities \= [] ->
        schedule_first_interval_heuristics(TSurgery, LPossibilities, (TinS, _)),
...
availability_operation_heuristics(OpCode,Room,Day,LPossibilities,LDoctors):-surgery_id(OpCode,OpType),surgery(OpType,_,TSurgery,_),
    findall(Doctor,assignment_surgery(OpCode,Doctor),LDoctors),
    intersect_all_agendas(LDoctors,Day,LA),
    agenda_operation_room1(Room,Day,LAgenda),
    free_agenda0(LAgenda,LFAgRoom),
    intersect_2_agendas(LA,LFAgRoom,LIntAgDoctorsRoom),
    remove_unf_intervals_heuristics(TSurgery,LIntAgDoctorsRoom,LPossibilities).


remove_unf_intervals_heuristics(_,[],[]).
remove_unf_intervals_heuristics(TSurgery,[(Tin,Tfin)|LA],[(Tin,Tfin)|LA1]):-DT is Tfin-Tin+1,TSurgery=<DT,!,
    remove_unf_intervals_heuristics(TSurgery,LA,LA1).
remove_unf_intervals_heuristics(TSurgery,[_|LA],LA1):- remove_unf_intervals_heuristics(TSurgery,LA,LA1).


schedule_first_interval_heuristics(TSurgery,[(Tin,_)|_],(Tin,TfinS)):-
...
% Ordena os médicos pela ocupação em ordem crescente
...
schedule_surgeries_heuristics(Room,Day,LRoom,LDAgendas):-
   get_time(Ti),
    ...
    collect_staff_agendas_heuristics(Day,LDAgendas), !,
    get_time(Tf),
    T is Tf-Ti,
...
list_staff_agenda_heuristics(_, [], []).
list_staff_agenda_heuristics(Day, [Staff | LStaff], [(Staff, UniqueAgStaff) | LAgStaff]) :-
    ...
    list_staff_agenda_heuristics(Day, LStaff, LAgStaff).

generate_staff_agendas_heuristics(Day, StaffAgendas) :-
    ...
    list_staff_agenda_heuristics(Day, UniqueStaffIds, StaffAgendas).
