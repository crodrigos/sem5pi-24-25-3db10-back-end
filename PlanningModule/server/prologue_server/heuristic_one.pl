...
agenda_staff(d9767, 20241214, [(720, 790, m01), (1080, 1140, c01)]).
agenda_staff(d8290, 20241214, [(901, 960, m02), (1380, 1440, c02)]).
agenda_staff(d9368, 20241214, [(720, 790, m01), (910, 980, m02)]).
agenda_staff(d7282, 20241214, []).
agenda_staff(d0719, 20241214, []).

agenda_staff(n7073, 20241214, []).
agenda_staff(n5177, 20241214, []).
agenda_staff(t1756, 20241214, []).
agenda_staff(n7902, 20241214, []).
agenda_staff(n1238, 20241214, []).
agenda_staff(n2519, 20241214, []).
agenda_staff(t0534, 20241214, []).
...
timetable(d9767, 20241214, (480, 1200)).
timetable(d8290, 20241214, (500, 1440)).
timetable(d9368, 20241214, (520, 1320)).
timetable(d7282, 20241214, (480, 1200)).
timetable(d0719, 20241214, (500, 1440)).
timetable(n7073, 20241214, (520, 1320)).

timetable(n5177, 20241214, (500, 1440)).
timetable(t1756, 20241214, (520, 1320)).
timetable(n7902, 20241214, (480, 1200)).
timetable(n1238, 20241214, (500, 1440)).
timetable(n2519, 20241214, (520, 1320)).
timetable(t0534, 20241214, (520, 1320)).
...
:- initialization(iniciar_servidor(8081)).
...
:- http_handler(root(calcular_heuristics_one), handle_obtain_better_sol_heuristic_one, []).

% Predicado para processar a requisição de /calcular_heuristics_one
handle_obtain_better_sol_heuristic_one(Request) :-
